                        ...
                        <div className="row justify-content-center">
                            ...
                            >
                                ...
                                <div className="media-body">
                                    ...
                                    <p className="mb-0">
                                        Lookout grog weigh anchor crack Jennys
                                        tea cup strike colors knave hardtack
                                        matey carouser...
                                    </p>
                                </div>
                            </div>
                            ...
                            >
                                ...
                                <div className="media-body">
                                    ...
                                    <p className="mb-0">
                                        Hogshead belaying pin crack Jennys tea
                                        cup piracy Nelsons folly jib wench log
                                        chase gun...
                                    </p>
                                </div>
                            </div>
